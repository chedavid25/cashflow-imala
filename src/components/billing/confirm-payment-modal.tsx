  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Confirmar Cobro">
      <div className="space-y-6 pb-4">
        ...
        <div className="bg-[#1a1a1a] p-4 rounded-2xl border border-white/5 space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-black text-white/20 uppercase tracking-widest">Facturado</span>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between px-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-black text-white/60 uppercase tracking-tight">¿Cambio de Divisa?</span>
            </div>
            <button
              onClick={() => {
              ...
              className={cn(
                ...
                isCurrencyChange ? "bg-primary border-primary/20" : "bg-white/5 border-white/5"
              )}
            >
              <div className={cn(
            ...
            {isCurrencyChange && (
              ...
              >
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-white/20 uppercase ml-1">Tipo de Cambio</label>
                  <div className="relative">
                    <Calculator className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-white/20" />
                    <input 
                      type="number"
                      placeholder="Ej: 1150"
                      value={exchangeRate}
                      onChange={(e) => setExchangeRate(e.target.value)}
                      className="w-full bg-[#1a1a1a] rounded-2xl h-12 pl-10 pr-4 border border-white/5 focus:border-primary/50 focus:outline-none text-sm transition-all"
                    />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-black text-white/20 uppercase ml-1">Fecha de Cambio</label>
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-[#1a1a1a] rounded-2xl h-12 pl-10 pr-4 border border-white/5 focus:border-primary/50 focus:outline-none text-sm transition-all text-white/60"
                    />
                  </div>
                </div>
              </motion.div>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-white/20 uppercase ml-1">Monto Final Recibido</label>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-[#1a1a1a] rounded-2xl h-14 pl-12 pr-4 border border-white/5 focus:border-primary/50 focus:outline-none text-xl font-black transition-all"
              />
            </div>
          </div>

          <div className="space-y-2">
            <label className="text-[10px] font-black text-white/20 uppercase ml-1">Cuenta de Destino</label>
            <div className="relative">
              <Landmark className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-white/20" />
              <select
                value={accountId}
                onChange={(e) => setAccountId(e.target.value)}
                className="w-full bg-[#1a1a1a] rounded-2xl h-14 pl-12 pr-10 border border-white/5 focus:border-primary/50 focus:outline-none text-sm transition-all appearance-none text-white/80"
              >
